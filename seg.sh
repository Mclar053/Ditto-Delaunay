...
if [ "$1" = "default" ]; then
  ...
  echo "Running command line project with interior images..."
  open -n ./bin/./creativeProject.app/ --args $2 $3 http://www.tekuto.com/wp-content/themes/tekuto2nd/images/topmain/toruso01.jpg?=20151006 https://static.dezeen.com/uploads/2014/02/Tokyo-house-with-skylight-framing-the-sky-by-Atelier-Tekuto_dezeen_12.jpg 
elif [ "$1" = "train" ]; then
  echo "Running command line project with interior images..."
